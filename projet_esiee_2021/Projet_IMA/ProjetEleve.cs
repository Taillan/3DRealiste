...
namespace Projet_IMA
{
    static class ProjetEleve
    {
        public static void Go()
        {
            ...
            Lumiere void_lumiere = new Lumiere(new V3(1, -.8f, 0), new Couleur(0, 0, 0) * .7f);

            ArrayList scene = new ArrayList();
            Parallelogramme3D RectangleA = new Parallelogramme3D(new V3(0, 0, 0), new V3(200, 100, 250), new V3(0, 150, 300), key_lumiere, void_lumiere, texture_murs, bump_texture_murs);
            Parallelogramme3D RectangleB = new Parallelogramme3D(new V3(200, 200, 250), new V3(500, 0, 0), new V3(0, 0, 300), key_lumiere, void_lumiere, texture_murs, bump_texture_murs);
            Parallelogramme3D RectangleC = new Parallelogramme3D(new V3(700, 0, 250), new V3(200, 100, -250), new V3(0, 150, 300), key_lumiere, void_lumiere, texture_murs, bump_texture_murs);
            Parallelogramme3D RectangleD = new Parallelogramme3D(new V3(50, 0, 25), new V3(800, 100, 0), new V3(100, 0, 300), key_lumiere, void_lumiere, texture_murs, bump_texture_murs);
