...
namespace Projet_IMA
{
    ...
    static class ProjetEleve
    {
        public static void Go()
        {
            ...
            Profondeur = 1000;
            Milieu = new V3(BitmapEcran.s_LargeurEcran / 2, 0f, 0f);
            Parallelogramme3D Sol4 = new Parallelogramme3D(new V3(0, 0, 0), new V3(Largeur, 0, 0), new V3(0, Profondeur, 0), Texture.s_White, bump_texture_murs);
            Parallelogramme3D MurGauche4 = new Parallelogramme3D(new V3(0, Profondeur, 0), new V3(0, 0, Hauteur), new V3(0, -Profondeur, 0), Texture.s_Green, Texture.s_Green);
            Parallelogramme3D MurFond4 = new Parallelogramme3D(new V3(0, Profondeur, 0), new V3(Largeur, 0, 0), new V3(0, 0, Hauteur), Texture.s_Blue, bump_texture_murs);
            Parallelogramme3D MurDroit4 = new Parallelogramme3D(new V3(Largeur, Profondeur, 0), new V3(0, -Profondeur, 0), new V3(0, 0, Hauteur), Texture.s_Red, bump_texture_murs);
            ...
            Parallelogramme3D LumierePlafond4 = new Parallelogramme3D_Lumiere(new V3((Largeur / 2) - 200, (Profondeur / 2) - 200, Hauteur - 1), new V3(0, 400, 0), new V3(400, 0, 0), new Couleur(1, 1, 1));
